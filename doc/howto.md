...
В VsCode аргументы нужно добавлять в файле \c .vscode/launch.json в поле args (см. картинку с \ref vscode_build "настройками launch.json").
...
вызвав контекстное меню и вызвав \c Build для обновления файлового дерева. В результате должен появится диалог с
